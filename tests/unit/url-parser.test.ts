...
describe('matchesSubdirectory', () => {
  it('should return true for same hostname and first path segment', () => {
    expect(matchesSubdirectory('https://example.com/docs/a', 'https://example.com/docs/b')).toBe(true)
  })
  ...
  it('should return false for different hostnames', () => {
    expect(matchesSubdirectory('https://a.example.com/docs', 'https://b.example.com/docs')).toBe(false)
  })
})
